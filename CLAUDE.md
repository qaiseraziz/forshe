...
## Current Version
**v1.2.2** (tagged 2026-04-19) — see `CHANGELOG.md` for full history.
...
- **Drawer** (v1.2.1-dev): "Today" standalone at the top + 5 collapsible groups — `DRAWER_GROUPS` in `src/navigation/DrawerNav.tsx`:
  ...
  - 💝 **Personal** — Prayer Times, Cycle Tracker, Body Stats (v1.2.2-dev added Prayer Times as first item; will grow in v1.3: Routine Builder, Habits, Mood, Journal, Me Time, Weekly Summary, Hidden Notes)
